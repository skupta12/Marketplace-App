  ...
  return (
    <MaxWidthWrapper>
      <div className="bg-white">
        <div
          className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid 
        ...
        >
          ...
          <div className="lg:max-w-lg lg:self-end">
            ...
            <div className="mt-4">
              <h1 className="text-3xl font-bold tracking-tight text-grsy-900 sm:text-4xl">
                {product.name}
              </h1>
            </div>
            ...
            <div>
              ...
              <div className="mt-6 text-center">
                <div className="group inline-flex text-sm font-medium">
                  <ShieldIcon aria-hidden="true" className="mr-2 h-5 w-5 flex-shrink-0 text-gray-400"
                  />
