  ...
  return (
    <div className="bg-white">
      <div
        ...
        pt-16 sm:px-6 lg:max-w-7xl lg:px-8"
      >
        ...
        <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                        ...
                        <div className="relative h-24 w-24">
                          {typeof image !== "string" && image.url ? (
                            <Image
                              ...
                              src={image.url}
                              alt="product image"
                              className="h-full w-full rounded-md object-cover object-center sm:h-40 sm:w-40"
                            />
                          ) : null}
                        </div>
                      </div>
          ...
          <section className="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0">
